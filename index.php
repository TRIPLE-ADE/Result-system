        ...
        <div class="login-card">
          <div>
            ...
            <div class="login-main">
              <form class="theme-form" action="controller/AuthController.php" method="POST">
                <h5 class="text-center">Summit University Results Processing System</h5>
                ...
                <div class="form-group mb-0">
                  <div class="text-end mt-3">
                    <button class="btn btn-success btn-block w-100" name="generate_otp" type="submit">Submit</button>
                  </div>
                </div>
              </form>
            </div>
