...
<head>
  ...
  <title>Bursary | Individual Result</title>
              ...
              <div class="col-sm-12">
                ...
                <div class="card">
                  <div class="card-header pb-0">
                    <h4 class="mb-3">Individual Result View</h4>
                    <form action="" method="post">
                        <div class="mb-3">
                          <label for="matric" class="form-label">Matric No</label>
                          <input type="text" name="matric" class="form-control" id="matric" placeholder="Matric No"> 
                        </div>
                        <div class="mb-3">
